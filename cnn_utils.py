...
def load_dataset():
    train_dataset = h5py.File('/home/samyaknn/ScienceProj2018/LungScan/lungdataset.hdf5', "r")
    ...
    test_dataset = h5py.File('/home/samyaknn/ScienceProj2018/LungScan/lungdataset.hdf5', "r")
...
def predict(X, parameters):
    ...
    x = tf.placeholder("float", [200704, 1])
