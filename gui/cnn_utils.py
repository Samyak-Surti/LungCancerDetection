...
def load_dataset():
    train_dataset = h5py.File('/home/samyak/ScienceProj2018/LungScan/lungdataset.hdf5', "r")
    ...
    test_dataset = h5py.File('/home/samyak/ScienceProj2018/LungScan/lungdataset.hdf5', "r")
